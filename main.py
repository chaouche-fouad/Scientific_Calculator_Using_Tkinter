...
for j in range(2, 5):
    for k in range(3):
        btn.append(Button(calc, width=6, height=2,
                          ...
                          bd=4, text=number_pad[i]))
        btn[i].grid(row=j, column=k, pady=1)
        btn[i]["command"] = lambda x=number_pad[i]: added_value.numberEnter(x)
        i += 1

btnClear = Button(calc, text=chr(67), width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                  command=added_value.Clear_Entry)
btnClear.grid(row=1, column=0, pady=1)

btnAllClear = Button(calc, text=chr(67) + chr(69), width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'),
                     bd=4, command=added_value.All_Clear_Entry)
btnAllClear.grid(row=1, column=1, pady=1)

btnsq = Button(calc, text="\u221A", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
               command=added_value.squared)
btnsq.grid(row=1, column=2, pady=1)

btnAdd = Button(calc, text="+", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                command=lambda: added_value.operation("add"))
btnAdd.grid(row=1, column=3, pady=1)

btnSub = Button(calc, text="-", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                command=lambda: added_value.operation("sub"))
btnSub.grid(row=2, column=3, pady=1)

btnMul = Button(calc, text="x", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                command=lambda: added_value.operation("multi"))
btnMul.grid(row=3, column=3, pady=1)

btnDiv = Button(calc, text="/", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                command=lambda: added_value.operation("divide"))
btnDiv.grid(row=4, column=3, pady=1)

btnZero = Button(calc, text="0", width=6, height=2, bg='#AFE1AF', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                 command=lambda: added_value.numberEnter(0))
btnZero.grid(row=5, column=0, pady=1)

btnDot = Button(calc, text=".", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                command=lambda: added_value.numberEnter("."))
btnDot.grid(row=5, column=1, pady=1)

btnPM = Button(calc, text=chr(177), width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
               command=added_value.mathPM)
btnPM.grid(row=5, column=2, pady=1)

btnEquals = Button(calc, text="=", width=6, height=2, bg='#7393B3', font=('Helvetica', 20, 'bold'), bd=4,
                   command=added_value.sum_of_total)
btnEquals.grid(row=5, column=3, pady=1)

# ROW 1 :
btnPi = Button(calc, text="pi", width=6, height=2, bg='#301934', fg='white', bd=4, font=('Helvetica', 20, 'bold'),
               command=added_value.pi)
btnPi.grid(row=1, column=4, pady=1)

btnCos = Button(calc, text="Cos", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=added_value.cos)
btnCos.grid(row=1, column=5, pady=1)

btntan = Button(calc, text="tan", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=added_value.tan)
btntan.grid(row=1, column=6, pady=1)

btnsin = Button(calc, text="sin", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=added_value.sin)
btnsin.grid(row=1, column=7, pady=1)

# ROW 2 :

btn2Pi = Button(calc, text="2pi", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=added_value.tau)
btn2Pi.grid(row=2, column=4, pady=1)

btnCosh = Button(calc, text="Cosh", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                 command=added_value.cosh)
btnCosh.grid(row=2, column=5, pady=1)

btntanh = Button(calc, text="tanh", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                 command=added_value.tanh)
btntanh.grid(row=2, column=6, pady=1)

btnsinh = Button(calc, text="sinh", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                 command=added_value.sinh)
btnsinh.grid(row=2, column=7, pady=1)

# ROW 3 :

btnlog = Button(calc, text="log", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=added_value.log)
btnlog.grid(row=3, column=4, pady=1)

btnExp = Button(calc, text="exp", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=added_value.exp)
btnExp.grid(row=3, column=5, pady=1)

btnMod = Button(calc, text="Mod", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
                command=lambda: added_value.operation("mod"))
btnMod.grid(row=3, column=6, pady=1)

btnE = Button(calc, text="e", width=6, height=2, bg='#301934', fg='white', font=('Helvetica', 20, 'bold'), bd=4,
...
def iExit():
    i_exit = tkinter.messagebox.askyesno("Scientific Calculator",
                                         "Do you want to exit ?")
    if i_exit > 0:
        root.destroy()
        return
